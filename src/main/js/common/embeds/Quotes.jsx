		...
		quotes: [
			{
				...
				description: 'Working with NextThought\'s team in our implementation process proved successful in numerous ways. They were responsive to our needs, worked tirelessly to exceed expectations and timelines, and helped us achieve our desired user experience.',
				avatar: DrHeidi,
				name: 'Dr. Heidi Scott',
			...
			},
			{
				...
				description: 'NextThought was instrumental in the success of the Online Master\'s program in Data Science and Analytics. The students found the platform easy to navigate with its crisp and clear interface.',
				avatar: DrSridhar,
			...
			},
			{
				...
				description: 'The NT platform has enhanced our business model; it has allowed us to market and sell a product we couldn\'t before. The platform\'s intuitive navigation makes it easy for our audience to navigate, and it\'s easy for us to edit course structure and features.',
				avatar: AshleySquier,
				name: 'Ashley Squier',
					...
					{quotes.map((quote, key) => (
						<div className={cx('slide')} key={key}>
							<div className={cx('quote')}>
								...
								<Text.Base as="p" className={cx('body')}>{quote.description}</Text.Base>
								<div className={cx('author')}>
									<img className={cx('avatar')} src={quote.avatar} alt={quote.name} />
									<div className={cx('info')}>
										<Text.Base className={cx('name')}>{quote.name}</Text.Base>
										<Text.Base className={cx('position')}>{quote.position}</Text.Base>
										<Text.Base className={cx('company')}>{quote.company}</Text.Base>
									</div>
								</div>
							</div>
						</div>
